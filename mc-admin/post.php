...
if (!is_dir(__COMMON_PATH__.'/posts/data/'))
  mkdir(__COMMON_PATH__.'/posts/data/');
...
function load_posts() {
  ...
  if (isset($_GET['state'])) {
    if ($_GET['state'] == 'draft') {
      $state = 'draft';
      $index_file = __COMMON_PATH__.'/posts/index/draft.php';
    }
    else if ($_GET['state'] == 'delete'){
      $state = 'delete';
      $index_file = __COMMON_PATH__.'/posts/index/delete.php';
    }
    else {
      $state = 'publish';
      $index_file = __COMMON_PATH__.'/posts/index/publish.php';
    }
  }
  else {
    $state = 'publish';
...
function delete_post($id) {
  ...
  if ($state != 'delete') {
    $index_file2 = __COMMON_PATH__.'/posts/index/delete.php';
    ...
    unlink(__COMMON_PATH__.'/posts/data/'.$id.'.dat');
  }
}
...
function revert_post($id) {
  ...
  $index_file2 = __COMMON_PATH__.'/posts/index/'.$prev_state.'.php';
